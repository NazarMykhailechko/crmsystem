    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#loanlist').DataTable({
                pageLength : 200,
                ajax : {
                    url : '${pageContext.request.contextPath}/api/clients/findallloans',
                    dataSrc : ''
                },
                scrollx: true,
                fixedHeader: {
                ...
                columns : [{
                    ...
                    "render": function(data, type, row, meta){
                        if(type === 'display'){
                            data = '<a href="/updateloan/' + data + '">Змінити</a>';
                    ...
                    title : 'Перелік наданих документів',
                    data : 'documents',
                    "render": function ( data, type, row, meta ) {
                    ...
                    "render": function ( data, type, row, meta ) {
                        if(data !== null){
                            return new Date(data).toLocaleDateString("be-BY") + " " +
                                new Date(data).toLocaleTimeString('en-US', { hour12: false, hour: "numeric", minute: "numeric"})
                        }
                        return data;
                    }
                }, {
                ...
                rowCallback: function(row, data, index) {
                    ...
                    if (data.status === "не надано всі документи") {
                        $(row).css('background-color','orange')
                    }
                    if (data.status === "прийнято в роботу") {
...
<div class="front-sign-in-left">
    <button onclick="location.href='/addloan'" style="background-color: crimson;color: white" type="button" class="btn btn-primary">Створити нову кредитну заявку</button>
</div>

<%--<h5 class="text">Created by Nazar Mykhailechko</h5>
<br>--%>
<h3 class="text">Список кредитних заявок:</h3>

<div>
<div class="table-wrapper">
    <div class="table-scroll">
        <table id="loanlist" class="compact hover" style="width: 100%"></table>
    </div>
</div>
</div>
